...
(function () {
  ...
  window.__BRAND__ = {
    ...
    // Fuente: horarios publicados en la ficha de Google del local.
    hours: {
      0: { open: 8 * 60, close: 24 * 60, label: "8:00 a 00:00" },
      1: { open: 8 * 60, close: 24 * 60, label: "8:00 a 00:00" },
      2: null,
      3: { open: 8 * 60, close: 24 * 60, label: "8:00 a 00:00" },
      4: { open: 8 * 60, close: 24 * 60, label: "8:00 a 00:00" },
      5: { open: 9 * 60, close: 25 * 60, label: "9:00 a 1:00" },
      6: { open: 9 * 60, close: 25 * 60, label: "9:00 a 1:00" }
    },
    hoursRows: [
      { label: "Lunes", value: "8:00 – 00:00" },
      { label: "Martes", value: "Cerrado" },
      { label: "Miércoles", value: "8:00 – 00:00" },
      { label: "Jueves", value: "8:00 – 00:00" },
      { label: "Viernes", value: "9:00 – 1:00" },
      { label: "Sábado", value: "9:00 – 1:00" },
      { label: "Domingo", value: "8:00 – 00:00" }
    ],
    ...
    // Ver carta.html para la carta completa con todos los precios.
    dishes: [
      { name: "Entraña rellena", price: "$25.000", desc: "Rellena de jamón, queso caramelizado y panceta, con papas doble cocción." },
      { name: "Bife de chorizo 350grs", price: "$30.000", desc: "A caballo, con papas fritas o ensalada de rúcula y parmesano." },
      { name: "Burger Wagyu", price: "$18.900", desc: "Pan brioche, medallón de Wagyu de 110grs, kimchi y mayonesa de sriracha." },
      { name: "Milanesa napolitana p/2", price: "$38.000", desc: "Para compartir, con papas doble cocción." },
      { name: "Volcán de chocolate", price: "$15.000", desc: "Centro de ganache de chocolate blanco, con helado de crema americana." },
      { name: "Fuego de Maracuyá", price: "$14.000", desc: "Vodka, maracuyá, almíbar de chile y lima — con promo 2x1." }
    ],
